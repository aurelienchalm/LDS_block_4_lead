...
with DAG(
    dag_id="housing_load_and_train",
    default_args=default_args,
    start_date=datetime(2025, 7, 30),
    schedule_interval=None,
    catchup=False,
    tags=["jenkins", "orchestrator"],
    ...
    # Exécution séquentielle : train après succès de load_to_db (ALL_SUCCESS par défaut)
    task_load_to_db >> move_to_processed >> task_train
    task_load_to_db >> move_to_failed
