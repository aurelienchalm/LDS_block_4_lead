...
# =================== DAG 1 : BUILD DATASETS ===================
with DAG(
    dag_id="housing_build_datasets",
    default_args=default_args,
    start_date=datetime(2025, 7, 29),
    schedule_interval=None,
    catchup=False,
    tags=["datasets", "evidently", "neondb", "s3"],
    ...
    move_previous_dataset >> [generate_current_data, generate_real_estate_dataset]
    
# =================== DAG 2 : RUN EVIDENTLY VIA JENKINS ===================
with DAG(
    dag_id="housing_evidently_reports",
    default_args=default_args,
    start_date=datetime(2025, 7, 29),
    schedule_interval=None,
    catchup=False,
    tags=["jenkins", "trigger", "evidently", "s3"],
    on_failure_callback=send_failure_email,
) as dag_evidently:
    ...
    trigger_jenkins_build >> notify_evidently_ready